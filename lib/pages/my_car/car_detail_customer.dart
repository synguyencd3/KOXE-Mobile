...
class CarDetailCustomer extends StatefulWidget {
  @override
  State<CarDetailCustomer> createState() => _CarDetailCustomerState();
}

class _CarDetailCustomerState extends State<CarDetailCustomer> {
  Car car = Car();
