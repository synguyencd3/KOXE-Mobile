        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              TextFormField(
                controller: _brand,
                decoration: InputDecoration(labelText: 'Hãng',
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12)
                  ),
                  focusedBorder: OutlineInputBorder(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Dung tích',
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12)
                  ),
                  focusedBorder: OutlineInputBorder(
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Màu ngoại thất',
                  enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(12)
                  ),
                  focusedBorder: OutlineInputBorder(
            ...
            DropdownButtonFormField<Warranty>(
              ...
              Padding(
                ...
                child: OutlinedButton(child: Text('Thêm xe'), onPressed: () {
                  NewCar();
                } ,),
